...
bcs = [bcu_inflow, bcu_wall, bcu_outflow, bcu_symmetry, bcp_right]
...
normal_stress_0 = assemble(inner(sig*n, n)*ds(0))
...
sav = 1.0
if sav == 1.0:
    File("Results/Isothermal" + mesh_ind + "NormalStress.pvd") << sig
    File("Results/velocity" + mesh_ind + "IsothermalNoStress.pvd") << u
    File("Results/pressure" + mesh_ind + "IsothermalNoStress.pvd") << p
