...
J = derivative(F_cyl, w, dw)
#J_cyl = derivative(F, w, dw)  # we need to change this Jacobian to the respective coordinate system

#problem = NonlinearVariationalProblem(F, w, bcs, J)
problem_cyl = NonlinearVariationalProblem(F_cyl, w, bcs, J)
#problem = MixedNonlinearVariationalProblem(F, w, bcs)
...
File("Meshes/DecoupledRefinedMesh.xml") << R.mesh()
