...
values = np.asarray([Pe_range, normal_stress_values, flux_values])
np.savetxt("Results/Coupled" + coord + "ChangingPeAdaptiveMesh.csv", values.T, delimiter='\t')
